...
List<List<double>> expected = [[15.0,-5.0,-5.0,-5.0],[-85.0,295.0,-105.0,-105.0],[-95.0,285.0,-85.0,-105.0],[-95.0,285.0,-45.0,-145.0]];
...
void main() {
  ...
  group('UNIT_TEST => PaymentServices Class => ', () {
    ...
    test('createSeriesList() test', (){
      List<charts.Series<ChartSeries, String>> l = ps.createSeriesList(balances);
    ...
    test('computeBalances()', (){
      ...
      for (int i=0; i<amount.length; i++) {
        l.add({'payedBy':users[i],'amount':amount[i], 'payedTo':payedTo[i]});
    ...
    test('formatDate()', (){
      ...
      expect(s, date.day.toString()+'/'+date.month.toString()+'/'+date.year.toString());
    });
